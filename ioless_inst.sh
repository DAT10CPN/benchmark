...
PETRI_TYPE="CPN"
if [ "$TEST_FOLDER" = "MCC2021" ] ; then
  PETRI_TYPE="PT"
fi
OUT_DIR="output/$(basename $BIN)/$PETRI_TYPE-$COL_RED_TIME_OUT-$RED_TIME_OUT-$COMB_TIME_OUT-$EXPL_TIME_OUT-ioless/$CATEGORY/$SEARCH_STRAT/$TEST_FOLDER/$NAME"
